...
const Heading = () => {
    ...
    return (<div className="heading">
        ...
        <img className='cakeHeading' src={cake1} alt="pic"/>
        <div className='textHeading'>
            ...
            <img className='cakeHeading' src={cake2} alt="pic"/>
        </div>
        <img className='cakeHeading' src={cake3} alt="pic"/>
        </div>
        <div className='heading2'>
            ...
            <img className='pavlova' src={pavlova} alt="pic"/>
            </div>
        </div>
    </div>)
}
